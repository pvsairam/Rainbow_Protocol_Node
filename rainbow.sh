...
echo -e "${CYAN}${BOLD}*     1 Click to Set Up Rainbow Protocol by       *${NC}"
echo -e "${CYAN}${BOLD}*               Airdrop OG                        *${NC}"
echo ""
echo ""
echo -e "${YELLOW}${BOLD}Make sure you have joined t.me/Airdrop_OG${NC}"
echo ""
...
echo "For support, you don’t need to donate. Just follow me on x.com/og_airdrop and join t.me/Airdrop_OG"
